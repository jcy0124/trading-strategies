...
!function (l) {
    ...
    Array.prototype.indexOf = Array.prototype.indexOf || function (n, i) {
        ...
        e && (n = n || {}, t !== h && t !== d("body")[0] || (n.clickType = "right"), i = "right" === n.clickType ? {
            left: (i = n.e || l.event || {}).clientX, top: i.clientY, right: i.clientX, bottom: i.clientY
...
!function (i, v) {
    ...
    s.formatArr = function (e) {
        ...
        return "limit" === e ? s.range ? (c(d.rangeLinked ? d.startDate : r), d.endDate && c(d.endDate)) : c(r) : ("string" == typeof (m = m || s.value) && (m = m.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), (a = function () {
            ...
            hours: s.dateTime.hours, minutes: s.dateTime.minutes, seconds: s.dateTime.seconds
        }, d.endTime = {
            hours: d.endDate.hours, minutes: d.endDate.minutes, seconds: d.endDate.seconds
        ...
        return d.year < h[0] && (d.year = h[0], o.hint(y.invalidDate)), d.year > h[1] && (d.year = h[1], o.hint(y.invalidDate)), o.firstDate || (o.firstDate = lay.extend({}, d)), s.setFullYear(d.year, d.month, 1), i = (s.getDay() + (7 - n.weekStart)) % 7, l = D.getEndDate(d.month || 12, d.year), r = D.getEndDate(d.month + 1, d.year), lay.each(c, function (e, t) {
            ...
            (t = lay(t)).removeAttr("class"), e < i ? (a = l - i + e, t.addClass("laydate-day-prev"), n = o.getAsYM(d.year, d.month, "sub")) : i <= e && e < r + i ? (a = e - i, o.rangeLinked || a + 1 === d.date && t.addClass(x)) : (a = e - r - i, t.addClass("laydate-day-next"), n = o.getAsYM(d.year, d.month)), n[1]++, n[2] = a + 1, t.attr("lay-ymd", n.join("-")).html("<div>" + n[2] + "</div>"), o.mark(t, n).holidays(t, n).limit({
                elem: t, date: {year: n[0], month: n[1] - 1, date: n[2]}, index: e
            })
            ...
            elem: lay(o.footer).find(C), index: 0, time: c
        ...
        return v[0] < 1 && (v[0] = 1), "year" === n ? (e = l = v[0] - 7, l < 1 && (e = l = 1), lay.each(new Array(15), function (e) {
            ...
            l == v[0] && lay(t).addClass(x), t.innerHTML = l + g, c.appendChild(t), d.limit({
                elem: lay(t), date: a, index: i, type: n
            }), l++
            ...
            lay(c).find("ol").each(function (a, e) {
                lay(e).find("li").each(function (e, t) {
                    d.limit({
                        elem: lay(t), date: [{hours: e}, {hours: d[T].hours, minutes: e}, {
                            hours: d[T].hours, minutes: d[T].minutes, seconds: e
                        }][a], index: i, time: [["hours"], ["hours", "minutes"], ["hours", "minutes", "seconds"]][a]
                    })
                })
            }), s.range || d.limit({
                elem: lay(d.footer).find(C), date: d[T], index: 0, time: ["hours", "minutes", "seconds"]
            })
            ...
            lay(this).hasClass(k) || (d.rangeLinked ? lay.extend(y, {
                year: "year" === n ? e : v[0], month: "year" === n ? v[1] - 1 : e
        ...
        }), layui.device().mobile && f.css({overflowY: "auto", touchAction: "pan-y"})), d
        ...
        l.range && !i.endState && lay(i.footer).find(C).addClass(k), r = r && i.newDate({
            ...
            year: i.endDate.year, month: i.endDate.month, date: i.endDate.date
        ...
        var n, i, t, l, r, o;
        e.hasClass(k) || (i = (n = this).config, t = a, n.rangeLinked && (n.endState || !n.startDate ? (a = 0, n.endState = !1) : (a = 1, n.endState = !0)), l = n.thisDateTime(a), lay(n.elem).find("td"), e = {
            year: 0 | (e = e.attr("lay-ymd").split("-"))[0], month: (0 | e[1]) - 1, date: 0 | e[2]
        }, lay.extend(l, e), i.range ? (lay.each(["startTime", "endTime"], function (e, t) {
            n[t] = n[t] || {
                hours: e ? 23 : 0, minutes: e ? 59 : 0, seconds: e ? 59 : 0
            }, a === e && (n.getDateTime(lay.extend({}, l, n[t])) < n.getDateTime(i.min) ? (n[t] = {
                hours: i.min.hours, minutes: i.min.minutes, seconds: i.min.seconds
            }, lay.extend(l, n[t])) : n.getDateTime(lay.extend({}, l, n[t])) > n.getDateTime(i.max) && (n[t] = {
                hours: i.max.hours, minutes: i.max.minutes, seconds: i.max.seconds
            }, lay.extend(l, n[t])))
        }), a || (n.startDate = lay.extend({}, l)), n.endState && !n.limit({date: n.thisDateTime(1 - a)}) && (((r = n.endState && n.autoCalendarModel.auto ? n.autoCalendarModel() : r) || n.rangeLinked && n.endState) && n.newDate(n.startDate) > n.newDate(n.endDate) && (n.startDate.year === n.endDate.year && n.startDate.month === n.endDate.month && n.startDate.date === n.endDate.date && (o = n.startTime, n.startTime = n.endTime, n.endTime = o), o = n.startDate, n.startDate = lay.extend({}, n.endDate, n.startTime), i.dateTime = lay.extend({}, n.startDate), n.endDate = lay.extend({}, o, n.endTime)), r) && (i.dateTime = lay.extend({}, n.startDate)), n.rangeLinked ? (e = lay.extend({}, l), !t || a || r || (o = n.getAsYM(l.year, l.month, "sub"), lay.extend(i.dateTime, {
            year: o[0], month: o[1]
        ...
        var i = this, l = i.config, r = i.thisDateTime(n), o = l.range && ("year" === l.type || "month" === l.type),
            d = i.elemCont[n || 0], s = i.listYM[n], e = function (e) {
                ...
                return t && (s[0] = e ? s[0] - 15 : s[0] + 15, i.list("year", n)), a && (e ? s[0]-- : s[0]++, i.list("month", n)), (t || a) && (lay.extend(r, {year: s[0]}), o && (r.year = s[0]), l.range || i.done(null, "change"), l.range || i.limit({
                    elem: lay(i.footer).find(C), date: {year: s[0]}
                })), i.setBtnStatus(), t || a
            };
        return {
            prevYear: function () {
...
!function (e, t) {
    ...
    var e = function (M) {
            ...
            for (e in g = H.support = {}, O = H.isXML = function (e) {
                ...
                cacheLength: 50, createPseudo: q, match: f, attrHandle: {}, find: {}, relative: {
    ...
    C.extend({
        cssHooks: {
            ...
            zIndex: !0,
            zoom: !0
        }, cssProps: {"float": y.cssFloat ? "cssFloat" : "styleFloat"}, style: function (e, t, n, r) {
    ...
    function A(i, e, t) {
        ...
        return C.map(g, jt, h), C.isFunction(h.opts.start) && h.opts.start.call(i, h), C.fx.timer(C.extend(p, {
            elem: i, anim: h, queue: h.opts.queue
    ...
    C.Animation = C.extend(A, {
        ...
        var r = e && "object" == typeof e ? C.extend({}, e) : {
            complete: n || !n && t || C.isFunction(e) && e, duration: e, easing: n && t || t && !C.isFunction(t) && t
        };
    ...
    C.extend({
        ...
        }, ajaxPrefilter: Qt(Yt), ajaxTransport: Qt(Jt), ajax: function (e, t) {
...
!function (p) {
        ...
        i = (u.anim = {
            ...
            if (s.id && m("." + u[0]).find("#" + s.id)[0]) e = m("#" + s.id).closest("." + u[0]), t = e.attr("times"), i = e.data("config"), n = m("#" + u.SHADE + t), "min" === (e.data("maxminStatus") || {}) ? g.restore(t) : i.hideOnClose && (n.show(), e.show()); else {
                ...
                o.vessel(r, function (e, t, i) {
                    ...
                    "background-color": s.shade[1] || "#000", opacity: s.shade[0] || s.shade
            ...
            e.tips[1] || o.remove(), a.autoLeft = function () {
                ...
                "background-color": e.tips[1], "padding-right": e.closeBtn ? "30px" : ""
            ...
            return a.move && t.css("cursor", "move"), t.on("mousedown", function (e) {
                ...
                d.eventMoveElem && (t = (a = d.eventMoveElem.data(r[0]) || {}).layero, o = a.config, s = e.clientX - a.offset[0], l = e.clientY - a.offset[1], i = "fixed" === t.css("position"), e.preventDefault(), a.stX = i ? 0 : h.scrollLeft(), a.stY = i ? 0 : h.scrollTop(), o.moveOut || (i = h.width() - t.outerWidth() + a.stX, n = h.height() - t.outerHeight() + a.stY, i < (s = s < a.stX ? a.stX : s) && (s = i), n < (l = l < a.stY ? a.stY : l) && (l = n)), t.css({
                    ...
                    width: a.area[0] + s, height: a.area[1] + l
            ...
            "min" !== c && ("max" === c && g.restore(e), r.data("maxminStatus", "min"), t = t || r.data("config") || {}, c = m("#" + u.SHADE + e), i = r.find(".layui-layer-min"), n = r.find(u[1]).outerHeight() || 0, o = (a = "string" == typeof (o = r.attr("minLeft"))) ? o : 181 * d.minStackIndex + "px", s = r.css("position"), l = {
                width: 180, height: n, position: "fixed", overflow: "hidden"
            ...
            "max" !== e && ("min" === e && g.restore(t), i.data("maxminStatus", "max"), d.record(i), u.html.attr("layer-full") || d.setScrollbar(t), setTimeout(function () {
                ...
                g.style(t, {
                    top: e ? 0 : h.scrollTop(), left: e ? 0 : h.scrollLeft(), width: "100%", height: "100%"
    ...
    g.prompt = function (i, n) {
        ...
        return delete n.success, g.open(m.extend({
            type: 1, skin: "layui-layer-tab" + v("tab"), resize: !1, title: function () {
        ...
        fixbar: function (i) {
            var o, t, e, n, r = "layui-fixbar", a = s(document), c = (i = s.extend(!0, {
                ...
                l = (i["default"] && (i.bar1 && i.bars.push({
                    type: "bar1", icon: "layui-icon-chat"
            ...
            layui.each(i.bars, function (t, e) {
                ...
                n.addClass(e.icon).attr({
                    "lay-type": e.type, style: e.style || (i.bgcolor ? "background-color: " + i.bgcolor : "")
            ...
            var e, n, i, o, r, a, c, u;
            (t = s.extend({
                margin: 160, duration: 200, type: "y"
...
layui.define(["jquery", "lay"], function (e) {
    ...
    var g = layui.$, x = layui.lay, m = {
        ...
        }, i = "slider", f = "layui-disabled", b = "layui-slider-bar", T = "layui-slider-wrap", w = "layui-slider-wrap-btn",
    ...
    t.prototype.config = {
        ...
        var t, e = a.disabled ? "#c2c2c2" : a.theme,
            ...
            l = g(a.elem), s = l.next(".layui-slider");
        ...
        function v(e) {
            var t = "vertical" === a.type ? a.height : n.elemTemp[0].offsetWidth, i = n.elemTemp.find("." + T);
            return ("vertical" === a.type ? t - e.parent()[0].offsetTop - i.height() : e.parent()[0].offsetLeft) / t * 100
        }

        function p(e) {
            "vertical" === a.type ? n.elemTemp.find("." + M).css({
                bottom: e + "%", "margin-bottom": "20px", display: "inline-block"
            }) : n.elemTemp.find("." + M).css({left: e + "%", display: "inline-block"})
        }
        ...
        var u = this, d = u.config, c = u.elemTemp, v = function () {
            ...
            }, p = c.find("." + T), o = c.next(".layui-slider-input"), r = o.children("." + L).children("input").val(),
            m = 100 / ((d.max - d.min) / Math.ceil(d.step)), f = function (e, t, i) {
                e = (e = 100 < (e = 100 < Math.ceil(e) * m ? Math.ceil(e) * m : Math.round(e) * m) ? 100 : e) < 0 ? 0 : e, p.eq(t).css("vertical" === d.type ? "bottom" : "left", e + "%");
                var n, a = h(p[0].offsetLeft), l = d.range ? h(p[1].offsetLeft) : 0,
                ...
                var t = e / v() * 100 / m, i = Math.round(t) * m;
        ...
        var c = this, a = c.config, s = c.elemColorBox.find("." + C), d = c.elemPicker.find("." + M + " input"), o = {
            clear: function (e) {
                ...
                -1 < l.indexOf(",") ? (t = Y(F(l)), c.select(t.h, t.s, t.b), s[0].style.background = o = "#" + j(t), 3 < (l.match(/[0-9]{1,3}/g) || []).length && "rgba" === s.attr("lay-type") && (r = 280 * l.slice(l.lastIndexOf(",") + 1, l.length - 1), c.elemPicker.find("." + D).css("left", r), o = s[0].style.background = l)) : (3 === (r = -1 < (r = l).indexOf("#") ? r.substring(1) : r).length && (r = (n = r.split(""))[0] + n[0] + n[1] + n[1] + n[2] + n[2]), n = {
                    r: (r = parseInt(r, 16)) >> 16, g: (65280 & r) >> 8, b: 255 & r
                        ...
                        i.find("." + p)[0] || (i.append(a), (i.hasClass(b) ? e.find("dd,>." + r) : e).on("mouseenter", function () {
                            !function (t, i, a) {
                                ...
                                i.hasClass(b) ? n[0] || (e = l.children("." + r), t.css({
                                    top: l.offset().top - i.offset().top, height: (e[0] ? e : l).outerHeight(), opacity: 1
                                })) : (n.addClass(g), n.hasClass("layui-nav-child-c") && n.css({left: -(n.outerWidth() - l.width()) / 2}), n[0] ? t.css({
                                    left: t.position().left + t.width() / 2, width: 0, opacity: 0
                                }) : t.css({
        ...
        var t, n, a, o, u = this, f = u.config, c = f.text || {}, l = u.elemFile[0], s = function () {
            ...
            var a = 0, o = 0, l = s(), r = function () {
                f.multiple && a + o === u.fileLength && "function" == typeof f.allDone && f.allDone({
                    total: u.fileLength, successful: a, failed: o
                })
            }, t = function (t) {
                    ...
                    var e = e || a.find("input,textarea"),
                        t = (i.autocomplete && e.attr("autocomplete", i.autocomplete), function (e, t) {
                            ...
                            isNaN(a) || ("click" === t && (a = !!C(this).index() ? a - n : a + n), t = function (e) {
                                ...
                                increment: e.next().find(".layui-icon-up"), decrement: e.next().find(".layui-icon-down")
                        ...
                        i.after(l), function (a, n) {
                            ...
                            a.on("click", function () {
                                ...
                                l[0].disabled || (l[0].indeterminate && (l[0].indeterminate = !1, a.find("." + o.SUBTRA).removeClass(o.SUBTRA).addClass("layui-icon-ok")), l[0].checked ? (l[0].checked = !1, a.removeClass(n[1]), "switch" === i && a.children("div").html(e[1])) : (l[0].checked = !0, a.addClass(n[1]), "switch" === i && a.children("div").html(e[0])), layui.event.call(l[0], w, n[2] + "(" + t + ")", {
                                    elem: l[0], value: l[0].value, othis: a
                                }))
                            })
                        }.call(this, l, r)
                    })
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (n) {
    "use strict";
    var f = layui.$, r = layui.lay, m = layui.laytpl, O = layui.laypage, p = layui.layer, v = layui.form,
        g = layui.util, b = layui.hint(), x = layui.device(), k = {
            config: {
                checkName: "LAY_CHECKED", indexName: "LAY_INDEX", numbersName: "LAY_NUM", disabledName: "LAY_DISABLED"
        ...
        E = ".layui-table-sort", A = "layui-table-checked", _ = "layui-table-edit", M = "layui-table-hover",
        ...
        d = f(window), F = f(document), i = function (e) {
            ...
            var e, i, l = this, n = l.config,
                ...
                r = function () {
                    "object" == typeof n.initSort && l.sort({
                        field: n.initSort.field, type: n.initSort.type, reloadType: t.type
                    })
                }, c = function (e, t) {
            ...
            t = t || {}, "function" == typeof n.before && n.before(n), l.startTime = (new Date).getTime(), t.renderData ? ((e = {})[d.dataName] = k.cache[l.key], e[d.countName] = n.url ? "object" === layui.type(n.page) ? n.page.count : e[d.dataName].length : n.data.length, "object" == typeof n.totalRow && (e[d.totalRowName] = f.extend({}, l.totalRow)), l.renderData({
                res: e, curr: a, count: e[d.countName], type: t.type, sort: !0
                ...
                success: function (e) {
                    (e = "function" == typeof n.parseData ? n.parseData(e) || e : e)[d.statusName] != d.statusCode ? l.errorView(e[d.msgName] || '\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"' + d.statusName + '": ' + d.statusCode) : (l.totalRow = e[d.totalRowName], l.renderData({
                        res: e, curr: a, count: e[d.countName], type: t.type
            ...
            var a = this, i = a.config, t = e.res, l = e.curr, n = a.count = e.count, o = e.sort,
                d = t[i.response.dataName] || [], t = t[i.response.totalRowName], r = [], c = [], s = [], u = function () {
                    if (!o && a.sortKey) return a.sort({
                        field: a.sortKey.field, type: a.sortKey.sort, pull: !0, reloadType: e.type
                    });
                    a.getTrHtml(d, o, l, {
                        trs: r, trs_fixed: c, trs_fixed_r: s
            ...
            return k.cache[a.key] = d, a.layTotal[0 == d.length ? "addClass" : "removeClass"](y), a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](R), a.layPage.find(I)[!i.page || 0 == n || 0 === d.length && 1 == l ? "addClass" : "removeClass"](y), 0 === d.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(R), o ? u() : (u(), a.renderTotal(d, t), a.layTotal && a.layTotal.removeClass(R), void (i.page && (i.page = f.extend({
            ...
            c.totalRow && (layui.each(e, function (e, i) {
                ...
                var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals" in t ? t.totalRowDecimals : 2,
                    ...
                    l = (a = t.totalRowText || "", (n = {LAY_COL: t})[e] = l, n = t.totalRow && T.call(r, {
                        item3: t, content: l, tplData: n
                    }) || a, i || n), n = (t.field && r.dataTotal.push({
                        field: t.field, total: f("<div>" + l + "</div>").text()
                        ...
                        TOTAL_NUMS: i || s[e], TOTAL_ROW: o || {}, LAY_COL: t
                    }, t)) : l), "</div></td>"].join(""));
                d.push(n)
            ...
            t.sortKey = {
                ...
                res: a, curr: t.page, count: t.count, sort: !0, type: l.reloadType
            ...
            r.getStyleRules(e, function (e) {
                if (e.selectorText === ".laytable-cell-" + t) return a(e), self !== parent && (e = r.elem("input", {style: "position: absolute; left: 0; top: 0; opacity: 0.01;"}), document.body.appendChild(e), e.focus(), document.body.removeChild(e)), !0
            })
            ...
            var r = this, c = ".layui-table-cell", e = "array" === layui.type(e) ? e : [e], s = k.cache[r.key] || [];
            layui.each(e, function (e, t) {
                var a, l, n, o, d;
                a = t.index, l = t.data, n = t.related, o = s[a] || {}, d = r.layBody.find('tr[data-index="' + a + '"]'), layui.each(l, function (e, t) {
                    ...
                    (i in l || ("function" == typeof n ? n(i, e) : n) && (t.templet || t.toolbar)) && (i = (e = d.children('td[data-field="' + i + '"]')).children(c), a = o[t.field], i.html(T.call(r, {
                        item3: t, content: a, tplData: f.extend({LAY_COL: t}, o)
            ...
            var c = this, s = c.config, u = s.elem.attr("lay-filter"), e = c.layHeader.find("th"), y = ".layui-table-cell",
                o = f("body"), d = {}, r = (c.layTool.on("click", "*[lay-event]", function (e) {
                    ...
                    t[0].disabled || (n ? c.setRowChecked({index: "all", checked: l}) : (c.setRowChecked({
                        ...
                        checked: l, type: n ? "all" : "one", getCol: function () {
                    ...
                    var e = f(this), t = e.parent(), a = this.value, i = e.parent().data("field"),
                        e = e.closest("tr").data("index"), e = k.cache[c.key][e], l = r.call(t[0], {
                    ...
                    var a = f(this), i = a.parent(), l = i.data("key"), n = c.col(l), o = i.parent().data("index"),
                        d = i.children(y), i = "layui-table-cell-c", r = f('<i class="layui-icon layui-icon-up ' + i + '">');
        ...
        u.href = "data:" + s + ";charset=utf-8,\ufeff" + encodeURIComponent((o = [], d = [], i = [], r = {}, layui.each(t, function (i, l) {
            ...
            "object" == typeof e ? (layui.each(e, function (e, t) {
                ...
                !1 === t.ignoreExport || t.field && "normal" == t.type ? t.hide && !1 !== t.ignoreExport || !0 === t.ignoreExport ? 0 == i && (r[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""), 0 == i && o.push(t.fieldTitle || t.title || t.field || ""), a = (a = T.call(c, {
                    item3: t, content: a, tplData: l, text: "text", obj: {
                        td: function (e) {
...
layui.define(["table"], function (e) {
        ...
        X = "LAY_ASYNC_STATUS", n = ["all", "parent", "children", "none"], t = function (e) {
            ...
            r.url ? e && (!c || c.mod) || (a.parseData = function () {
                ...
                if (i.length && (e = j.checkStatus(l), i.prop({
                    checked: e.isAll && e.data.length, indeterminate: !e.isAll && e.data.length
    ...
    t.prototype.init = function () {
        ...
        tree: {
            customName: {
                children: "children", isParent: "isParent", name: "name", id: "id", pid: "parentId", icon: "icon"
            },
            view: {
                indent: 14,
        ...
        return e ? (a = (t = n.getOptions()).tree, t.id, a.customName, {
            data: e, dataIndex: e[Y], getParentNode: function () {
        ...
        return i ? ((e = n.getOptions()).tree.customName.parent, a = e.id, (e = {
            data: i, dataIndex: i[Y], getParentNode: function () {
    ...
    var r, V = function (e, t, a) {
        ...
        if (v !== undefined && (c.status.expand[v] = x), null !== h) {
            ...
            if (x) if (m) {
                ...
                y[z] = !0, v.length && (!o.initSort || o.url && !o.autoSort || ((m = o.initSort).type ? layui.sort(v, m.field, "desc" === m.type, !0) : layui.sort(v, B.config.indexName, null, !0)), c.initData(y[s.children], y[Y]), w = B.getTrHtml(r, v, null, null, e), S = {
                    trs: E(w.trs.join("")), trs_fixed: E(w.trs_fixed.join("")), trs_fixed_r: E(w.trs_fixed_r.join(""))
                }, A = (e.split("-").length - 1 || 0) + 1, layui.each(v, function (e, t) {
                    S.trs.eq(e).attr({
                        "data-index": t[Y], "lay-data-index": t[Y], "data-level": A
        ...
        o && ((d = o.getOptions()).tree, d = (n = d.elem.next()).find('tr[lay-data-index="' + a + '"]'), i = d.attr("data-index"), l = d.attr("data-level"), t) && (d = o.getNodeDataByIndex(a, !1, t), r = B.getTrHtml(e, [d]), layui.each(["main", "fixed-l", "fixed-r"], function (e, t) {
            n.find(".layui-table-" + t + ' tbody tr[lay-data-index="' + a + '"]').replaceWith(E(r[["trs", "trs_fixed", "trs_fixed_r"][e]].join("")).attr({
                "data-index": i, "lay-data-index": a, "data-level": l
            }))
        ...
        r && (d = (a = r.getOptions()).tree, n = a.elem.next(), i = [], t = r.getNodeDataByIndex("string" === layui.type(t) ? t : t[Y], !1, "delete"), l = r.getNodeDataByIndex(t[s]), r.updateCheckStatus(l), l = r.treeToFlat([t], t[d.customName.pid], t[s]), layui.each(l, function (e, t) {
            ...
            t[m] && t[m] !== t[Y] && n.find('tr[lay-data-index="' + t[m] + '"]').attr({
                "data-index": t[Y], "lay-data-index": t[Y]
            })
        ...
        if (a) {
            ...
            if (u) {
                ...
                var x, f = B.getTrHtml(e, c), h = {
                    trs: E(f.trs.join("")), trs_fixed: E(f.trs_fixed.join("")), trs_fixed_r: E(f.trs_fixed_r.join(""))
                }, r = (layui.each(c, function (e, t) {
                    x = {
                        "data-index": t[Y], "lay-data-index": t[Y], "data-level": "0"
    ...
    v.prototype.config = {
        ...
        n.elem.on("click", 'input[lay-filter="layTransferCheckbox"]+', function () {
            ...
            a[0].disabled || !1 !== ("function" == typeof l.dblclick ? l.dblclick({
                elem: t, data: n.getData([a[0].value])[0], index: i
            }) : null) && n.transfer(i, t)
...
layui.define(["jquery", "lay"], function (e) {
    ...
    i.prototype.config = {
        ...
        n.haveSlide || ("sub" === e ? (n.subIndex(i), t.eq(a.index).addClass(c), setTimeout(function () {
            ...
            index: a.index, prevIndex: o, item: t.eq(a.index)
...
layui.define("jquery", function (l) {
    ...
    e.prototype.load = function (l) {
        ...
        if (h[0]) return e = g(l.scrollElem || document), r = l.mb || 50, a = !("isAuto" in l) || l.isAuto, c = l.end || "\u6ca1\u6709\u66f4\u591a\u4e86", m = l.scrollElem && l.scrollElem !== document, u = g('<div class="layui-flow-more"><a href="javascript:;">' + (s = "<cite>\u52a0\u8f7d\u66f4\u591a</cite>") + "</a></div>"), h.find(".layui-flow-more")[0] || h.append(u), f = function (l, e) {
            ...
            elem: l.elem + " img", scrollElem: l.scrollElem
...
layui.define(["lay", "util", "element", "form"], function (e) {
    ...
    e("code", function (l, e) {
        ...
        return 1 < w.length ? layui.each(l.obverse ? w : w.get().reverse(), function () {
            ...
            copy: {
                className: "file-b", title: ["\u590d\u5236\u4ee3\u7801"], event: function (e) {
